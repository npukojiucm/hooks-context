...
export default function Details() {
    ...
    const userElement = !Object.keys(user).length ?
        ...
        : <ul className="user-info__list">
            ...
            <li className="list-item user-name">
                {user.name}
            </li>
            <li className="list-item user-city">
                {user.details.city}
            </li>
            <li className="list-item user-company">
                {user.details.company}
            </li>
            <li className="list-item user-position">
    ...
    return (
        ...
        //         {user.details.city}
        //     </li>
        //     <li className="user-company">
        //         {user.details.company}
        //     </li>
        //     <li className="user-position">
        //         {user.details.position}
        //     </li>
        // </ul>
    )
